...
const InputAvPersoner = () => {
    ...
    return (
        <div className="input-av-personer">
            ...
            <Knapp disabled={selectedPersons().length === 0}
                   onClick={() => fjernPersoner(selectedPersons())}>Slett ({selectedPersons().length})</Knapp>
            <Knapp onClick={() => context.endreSkjemaVerdi("personer", mockPersoner)}

            >Lagre og gå videre</Knapp>
