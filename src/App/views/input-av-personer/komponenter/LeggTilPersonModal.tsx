    ...
    return (
        ...
        >
            <div style={{padding: '2rem 2.5rem', overflow: "hidden"}}>
                ...
                <UndertekstBold>Lim inn fødselsnummeret til de som skal permitteres</UndertekstBold>
                <Normaltekst>
                    <ul>
                        <li>Du kan lime inn alle på en gang</li>
                        <li>Du kan lime inn alt innholdet i et excel ark så luker vi ut hva som er fødselsnummer</li>
                    </ul>
                </Normaltekst>
                <Textarea style={{maxHeight: "300px"}} maxLength={0} label="Berørte personer" value={textAreaContent}
                          onChange={
                              (e) => {
                ...
                {fnrCount > 0 && <Normaltekst>Finner totalt {fnrCount} personer.</Normaltekst>}
            </div>
            <Knapp disabled={fnrCount === 0} onClick={() => {
